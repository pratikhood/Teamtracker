package com.teamtracker.qa.util;
...
public class Reporting  extends TestListenerAdapter
{
	...
	public ExtentTest logger;
		...
		public void onStart(ITestContext testContext)
		{
			...
			htmlReporter.config().setDocumentTitle("Teamtracker"); //Title of the report
			...
			{
				logger=extent.createTest(tr.getName()); // create entry in the report
