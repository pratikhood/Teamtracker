...
public class TC_Import_Task_022 extends BaseClass
{


	@Test
	public void Import_POI() throws InterruptedException, Exception
	{
		...
		Task_Page.click_on_Import_button();
		
		Task_Page.click_on_choose_file_button();
		
		


		StringSelection stringSelection = new StringSelection("C:\\Users\\91888\\Desktop\\sales_tasks.xlsx");
		...
		Task_Page.click_on_upload_button();
