...
public class TC_Import_POI_018 extends BaseClass
{
	...
	public void Import_POI() throws InterruptedException, Exception
	{
		...
		POI_Page.click_on_Import_button();
		
		POI_Page.click_on_choose_file_button();


		StringSelection stringSelection = new StringSelection("C:\\Users\\91888\\Desktop\\poi.xlsx");
		...
		POI_Page.click_on_upload_button();
