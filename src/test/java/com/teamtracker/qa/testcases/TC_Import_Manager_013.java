...
public class TC_Import_Manager_013 extends BaseClass
{


	@Test
	public void Import_Manager() throws InterruptedException, Exception
	{
		...
		Manager_Page.click_on_import_button();
		
		Manager_Page.click_on_choose_file_button();


		StringSelection stringSelection = new StringSelection("C:\\Users\\91888\\Desktop\\manager.xlsx");
		...
		Manager_Page.click_on_upload_button();
